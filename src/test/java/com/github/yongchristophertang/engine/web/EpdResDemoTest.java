...
import com.github.yongchristophertang.engine.web.response.HttpResultMatchers;
...
//    private MongoTemplate mongoTemplate;
    ...
    public void test() throws Exception {
        ...
        Object object = webTemplate.perform(api(TestAPI.class).getGrades("1234", 456)).andDo(print())
                .andExpect(HttpResultMatchers.content().contentType("application/json;charset=utf-8"))
                .andExpect(HttpResultMatchers.jsonPath("$.code", is("10004040"))).andTransform(json().object(Object.class));
