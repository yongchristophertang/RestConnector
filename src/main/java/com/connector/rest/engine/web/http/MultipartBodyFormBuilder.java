...
public class MultipartBodyFormBuilder implements FormBuilder {
    ...
    /**
     * Add a request parameter to body in {@link com.connector.rest.engine.web.request.HttpRequestBuilders}
     *
    ...
    /**
     * Add an attaching file in body of {@link com.connector.rest.engine.web.request.HttpRequestBuilders}
     *
    ...
    /**
     * Add a bytes content in body of {@link com.connector.rest.engine.web.request.HttpRequestBuilders}
     *
    ...
    /**
     * Create a {@link BodyForm} instance
     *
     * @return {@link BodyForm}
     */
    @Override
