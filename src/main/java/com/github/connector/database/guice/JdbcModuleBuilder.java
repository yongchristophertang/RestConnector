...
import com.github.connector.database.guice.provider.JdbcTemplateFactory;
 ...
 * marked {@link com.github.connector.database.annotations.SqlDB} annotations on {@code Class<?> clazz} and its
 * superclasses.
 *
 * @author Yong Tang
 * @since 0.4
