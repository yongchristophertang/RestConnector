...
import com.github.connector.engine.web.http.MultipartBodyFormBuilder;
...
import static com.github.connector.engine.AssertUtils.notNull;
...
public final class RequestProxy implements InvocationHandler {
    ...
    /**
     * Get the singleton instance of {@link com.github.connector.engine.web.request.RequestProxy}.
     */
