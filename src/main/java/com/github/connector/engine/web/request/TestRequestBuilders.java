...
import com.github.connector.engine.web.http.HttpMethod;
...
public abstract class TestRequestBuilders {
    ...
    /**
     * Create a {@link com.github.connector.engine.web.request.HttpMultipartRequestBuilders} for a request with the
     * given HTTP method.
     *
     * @param httpMethod   the HTTP method
     * @param urlTemplate  a URL template; the resulting URL will be encoded
     ...
     * {@code clientIface} will return a {@link com.github.connector.engine.web.request.RequestBuilder} or, more
     * concrete, {@link com.github.connector.engine.web.request.HttpRequestBuilders}.
     *
